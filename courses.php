...
if(isset($_POST['save'])){
    ...
    $sql = "INSERT INTO `courses` (department) VALUES ('$name')";
...
if(isset($_POST['delete'])){
    ...
    $sql2="DELETE FROM `courses` WHERE course_id='$position_id'";
...
<div class="container">
    ...
    <form id="login-form"action=""method="POST">
      <div class="form-group">
        <label for="id">Departments:</label>
        <input type="text" id="position_id" name="department" required>
...
<table>
  ...
  <tbody>
    <?php 
    $i = 1;
    $course = $conn->query("SELECT * FROM `courses` ORDER BY course_id ASC");
