    ...
    <div class="row my-5">
      <div class="col-md-7">
        ...
        try {
            ...
            $sql = "SELECT * FROM candidate WHERE position_id = '2'";
            $stmt = $pdo->query($sql);
            ...
            foreach ($candidates as $candidate) {
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                    ...
                    echo isset($candidate['role']) ? $candidate['role'] : ''; 
                    ?>
                    <br>
                  </div>
                </div>
...
<!-- VICE PRESIDENT -->
  ...
  <!-- GENERAL SECRETARY -->
  <div class="container my-5">
    <h2 class="my-3">General Secretary</h2>
    <div class="row my-5">
      <div class="col-md-7">
        ...
        try {
            ...
            // Query to fetch candidates for president position
            $sql = "SELECT * FROM candidate WHERE position_id = '4'";
            $stmt = $pdo->query($sql);
  ...
  <div class="container my-5">
    <h2 class="my-3">Asst. General Secretary</h2>
    <div class="row my-5">
      <div class="col-md-7">
        ...
        try {
            ...
            // Query to fetch candidates for president position
            $sql = "SELECT * FROM candidate WHERE position_id = '5'";
            $stmt = $pdo->query($sql);
